...
- **Human feedback is opt-in.** No one should review docs or PRs unless explicitly asked. Specialized agents do this by default. People are tagged only when needed.
...
- Currently syncing between systems is copy-paste. Between two or more systems. Also because docs use custom things like diagrams etc, it requires tons of clicks or custom setup. The question is why. We need to remove unnecessary steps.
